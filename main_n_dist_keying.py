...
export_adapted_abbyy_result = False
if export_adapted_abbyy_result:
    """
        ...
        if necessary)
    """
    hocr_comparator_abbyy = HocrBBoxComparator()

    abbyy_ocr_lists = []
    abbyy_ocr_lists.append(abbylist_normalized)
    abbyy_ocr_comparison = hocr_comparator_abbyy.compare_lists(abbyy_ocr_lists)
    abbyy_ocr_comparison.add_line_information(lhi_abbyy_normalized)
    abbyy_ocr_comparison.sort_set()
    abbyy_ocr_comparison.do_n_distance_keying()
    abbyy_ocr_comparison.save_n_distance_keying_results_to_file("./Testfiles/oneprof_abbyy_result.txt_lh_adapted", True)
...
ocr_validator.set_ocr_file("./Testfiles/oneprof_abbyy.txt")
ocr_validator.compare_ocrolib_edist(ignore_linefeed, ignore_whitespace)
ocr_validator.set_ocr_file("./Testfiles/oneprof_abbyy_result.txt_lh_adapted")
ocr_validator.compare_ocrolib_edist(ignore_linefeed, ignore_whitespace)
ocr_validator.set_ocr_file("./Testfiles/oneprof_tesseract_questionmark.txt")
ocr_validator.compare_ocrolib_edist(ignore_linefeed, ignore_whitespace)
...
# todo create a ocropus textfile for reference one day
...
if display_differences:
    ...
    # mind this is the line heighth adapted text, generated by this file
    pyc_handler.show_file_comparison("./Testfiles/oneprof.gt.txt", "./Testfiles/oneprof_abbyy_result.txt_lh_adapted")
    pyc_handler.show_file_comparison("./Testfiles/oneprof.gt.txt", "./Testfiles/oneprof_tesseract_questionmark.txt")