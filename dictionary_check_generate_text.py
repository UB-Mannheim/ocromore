...
from dictionary_check_create_sequences import config, main_create_aufsichtsrat_sequences, generate_tokens
...
# load the model
model = load_model('model_aufsichtsrat_cds.h5')

# load the tokenizer
tokenizer = load(open('tokenizer_aufsichtsrat_cds.pkl', 'rb'))
