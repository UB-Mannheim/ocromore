...
CODED_CONFIGURATION_PATH_VOTER = './configuration/voter/config_voter_example.conf'  # configuration which is not given with cli args
CODED_CONFIGURATION_PATH_DB_READER = './configuration/to_db_reader/config_reader_example.conf'  # configuration which is not given with cli args
